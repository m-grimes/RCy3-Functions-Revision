...
# deleteGroup(c("CDK1",    "CRK",     "DDX5"))
# collapse.CCCN.nodes()
# NOTE: Causes hang or very slow
?commandsRun
# expandGroup("all")
# From Alex Pico
...
# And here’s a new function I’ll add to RCy3 to make it easier to use this column-based option. And it should work within the function you devised (see slightly altered version below).
...
# Note error: Error in paste(base.url, "commands", sub(" ", "/", cmd), sep = "/") :  object '.defaultBaseUrl' not found 
